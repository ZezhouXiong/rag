...
//                .connectedTo("192.168.88.101:9200")  // 确保地址和端口正确
//                .build();
...
//        elasticsearchRestTemplate = new ElasticsearchRestTemplate(rest);
        ...
        SearchHits<ElasticVectorData> dataSearchHits = elasticsearchRestTemplate.search(nativeSearchQuery, ElasticVectorData.class, IndexCoordinates.of(collectionName));
